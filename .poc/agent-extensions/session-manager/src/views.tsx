...
const STYLE_ID = 'agentnest-session-manager-style';
const CSS = `
...
const SessionManager = () => {
  ...
  const selectSession = useCallback((id: string) => {
    ...
    window.dispatchEvent(new CustomEvent('agentnest:session-changed', { detail: { id } }));
  }, []);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('span', { className: 'an-sm__user' }, 'AgentNest')
    )
  );
};

exports['agentnest.sessionManager'] = SessionManager;
